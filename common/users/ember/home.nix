  ...
  home-manager.users."${username}" = {
    ...
    xdg = {
      ...
      configFile = {
        ...
        "nix/nix.conf".text = ''
          substituters = https://cache.nixos.org https://nixpkgs-update-cache.nix-community.org https://winapps.cachix.org/ https://nix-community.cachix.org https://nixcache.reflex-frp.org https://miso-haskell.cachix.org https://nixcache.webghc.org https://cache.iog.io https://static-haskell-nix.cachix.org # https://dandart.cachix.org # https://cache.jolharg.com
