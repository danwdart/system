...
$IP4T -A INPUT -p udp -s $NET4 -d $BCAST4_ALL -m multiport --dport 13210:13224 # --sport 29312
...
# MDNS Out
$IP4T -A OUTPUT -p udp -s $NET4 -d $MULTICAST4_4 --dport 5353 -j ACCEPT
...
# KDE Connect
$IP4T -A OUTPUT -p tcp -s $NET4 -d $NET4 -m multiport --dport 1714:1764 -j ACCEPT
$IP6T -A OUTPUT -p tcp -s $NET6 -d $NET6 -m multiport --dport 1714:1764 -j ACCEPT
$IP4T -A OUTPUT -p udp -s $NET4 -d $NET4 -m multiport --dport 1714:1764 -j ACCEPT
$IP4T -A OUTPUT -p udp -s $NET4 -d $BCAST4_ALL -m multiport --dport 1714:1764 -j ACCEPT
$IP6T -A OUTPUT -p udp -s $NET6 -d $NET6 -m multiport --dport 1714:1764 -j ACCEPT

# KDE Connect (Scanning)
$IP4T -A OUTPUT -p tcp -s $NET4 -d $BCAST4 -m multiport --dport 1714:1764 -j ACCEPT
$IP6T -A OUTPUT -p tcp -s $NET6 -d $ALL_IL_AN6 -m multiport --dport 1714:1764 -j ACCEPT
$IP6T -A OUTPUT -p tcp -s $NET6 -d $ALL_LL_AN6 -m multiport --dport 1714:1764 -j ACCEPT
$IP4T -A OUTPUT -p udp -s $NET4 -d $BCAST4 -m multiport --dport 1714:1764 -j ACCEPT
$IP6T -A OUTPUT -p udp -s $NET6 -d $ALL_IL_AN6 -m multiport --dport 1714:1764 -j ACCEPT
$IP6T -A OUTPUT -p udp -s $NET6 -d $ALL_LL_AN6 -m multiport --dport 1714:1764 -j ACCEPT
...
$IP4T -A OUTPUT -p udp -s $NET4 -m multiport --dport 137,139,445,3702,5357 -j ACCEPT
