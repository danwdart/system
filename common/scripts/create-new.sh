...
touch common/private/{sasl_passwd,users/{root,raven,dwd}/hashed_password,tt-rss/{dbpass,email_from_address,email_login,email_password,email_server},nextcloud/{dbpass,adminpass},msf/dbpass}
echo TODO: put junk in the files! Accept emails and hostnames as params etc.
echo TODO the picture file of me
echo TODO passwords for users